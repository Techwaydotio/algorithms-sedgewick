...
2. For each pair of points calculate the distance between them using the Euclidean distance formula:
...
It prints "world" followed by "hello"
...
## 1.2.9
> Instrument BinarySearch (page 47) to use a Counter to count the total number of keys examined during all searches and then print the total after all searches are complete. 
...
static class VisualCounter {
    ...
    public void increment() {
        // increment as long as we are under max
